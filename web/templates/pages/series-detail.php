    ...
    <main class="pt-20 max-w-5xl mx-auto px-4 pb-12">
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-2/3">
                ...
                <?php if(!empty($resumeSlug)): ?>
                    <a href="/episodes/<?= htmlspecialchars($resumeSlug) ?>" class="inline-block bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full transition-colors text-lg">
                        <?= $hasHistory ? 'Resume' : 'Play Episode 1' ?>
                    </a>
                <?php endif; ?>
            </div>
        </div>
