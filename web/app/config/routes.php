...
$router->get('/advertise', 'AdvertiseController@index');
$router->post('/advertise/subscribe', 'AdvertiseController@subscribe');
$router->post('/advertise/renew/{id}', 'AdvertiseController@renew');
$router->get('/my-ads', 'MyAdsController@index');
...
$router->get('/admin/ad-pricing', 'AdPricingController@index');
$router->post('/admin/ad-pricing', 'AdPricingController@index');
...
$router->get('/api/v1/ads/pricing', 'Api\CustomAdController@pricing');
$router->post('/api/v1/ads/subscribe', 'Api\CustomAdController@subscribe');
$router->get('/api/v1/ads/my-ads', 'Api\CustomAdController@myAds');
$router->post('/api/v1/ads/renew/{id}', 'Api\CustomAdController@renew');
