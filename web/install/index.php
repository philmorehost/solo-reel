...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($step == 1) {
        ...
        try {
            ...
            // Run schema
            $schemas = ['001_initial_schema_mysql.sql', '002_payment_gateway.sql', '003_add_seo_columns.sql', '004_video_queue.sql', '005_additional_features.sql', '006_update_features.sql'];
