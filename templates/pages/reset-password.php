...
<head>
    <meta charset="UTF-8">
    <title>Reset Password - SOLOREEL</title>
...
<body class="bg-black text-white antialiased font-sans flex items-center justify-center min-h-screen">
    <div class="w-full max-w-md bg-gray-900 p-8 rounded-lg shadow-xl border border-gray-800">
        ...
        <h3 class="text-xl mb-6 text-center text-gray-300">Create new password</h3>
        ...
        <form action="/reset-password" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="password" name="password" required minlength="6" class="w-full bg-black border border-gray-700 rounded px-4 py-2 text-white focus:outline-none focus:border-red-500">
            </div>
